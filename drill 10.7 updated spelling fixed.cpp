...
bool same_points(vector<Point>& ps_1, vector<Point>& ps_2){
...
int main(){
    ...
    for (;original_points.size() < nurm_of_points;)
    {
        ...
        {
            cout << "I think you typed the points in the wrong format!" << endl;
            cin.clear();
        }
    }
    cout << endl;
    ...
    if (same_points(original_points,processed_points))
    {
        cout << "vectors MATCHED! Great!" << endl;
    }
    else
    {
